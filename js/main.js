    ...
    output = '<div class="mt-5 mb-5 d-flex justify-content-center">' +
        '<div class="container-fluid w-75">' +
            ...
            '<div class="row bg-red01">' +
                '<div class="col-6 foSize-2em foColor-white01 foWeight-700 pt-2 pb-2">' + channel.username.toUpperCase() + '</div>' +
                '<div class="col-6 foSize-2em foColor-white01 text-right foWeight-100 pt-2 pb-2"><a class="" href="https://www.youtube.com/channel/' + channel.id + '" target="_blank">View Channel</a></div>' +
            '</div>' +
            '<!--statistics-->' +
